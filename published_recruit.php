...
if ($type=="admin") {
$recruit = ruiqia_page("SELECT * from recruit ORDER BY time DESC",5,7,'page');
   
}
if ($type==''or $type==null) {
   $recruit = ruiqia_page("SELECT * from recruit WHERE userid='".$_SESSION['userid']."' ORDER BY time DESC",5,7,'page');
}
