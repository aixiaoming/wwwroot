...
<div class="right_container">
    ...
    <table>
		<tr>
			...
			<td><a href="/published_shop.php" class="type">校园周边</a></td>
    ...
    <!--{if $user['administrator']==1}-->
        ...
        <table>
        	<tr>
        		<td><a href="published_shop.php" class="type">管理员个人发布</a></td>
        		<td><a href="published_shop.php?type=admin">网站总发布</a></td>
        	</tr>
        </table>
        <!--{/if}-->
        <!--{if $type=="admin"}-->
        <table>
        	<tr>
        		<td><a href="published_shop.php">管理员个人发布</a></td>
        		<td><a href="published_shop.php?type=admin" class="type">网站总发布</a></td>
        	</tr>
        </table>
        <!--{/if}-->
        </div>
