            ...
            function(res){
                ...
                // window.location.href="http://www.baidu.com";
                  if(res.err_msg == "get_brand_wcpay_request:ok"){
                   ...
                   window.location.href="http://www.bangbangdream.com/weixinsocial.php";
...
<a href="social.php"><button style="width: 100px;height: 30px;background-color: #f58710;border:0px;font-size: 16px;color: #fff;border-radius: 4px;cursor: pointer;margin-top: 10px;">再次申请</button></a>
</center>
<!--{/if}-->
...
<!--{if $user['test']==0}-->
    ...
    <div class="rmb">
        <div>
            <div class="pay">　　申请社会个人认证会员，需缴纳会籍费100元/年，然后提交会员资料，会员仅限在校大学生。
