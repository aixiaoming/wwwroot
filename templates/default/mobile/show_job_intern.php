...
<ul class="xiangqing_xinxi">
      ...
      <li><a>联系邮箱：$xinxi['linkemail']</a></li>
        <!--{/if}-->
          ...
          <!--{if $xinxi['find']==1}-->  
          <!-- 招实习 -->
      <li><a>单位名称：$xinxi['name']</a></li>
      <li><a>年龄要求：$xinxi['old']</a></li>
      <li><a>招聘职位：$xinxi['position2']</a></li>
      <li><a>薪资待遇：$xinxi['wage']</a></li>
      <li><a>招聘人数：$xinxi['people']</a></li>
      <li><a>工作地点：$xinxi['address']</a></li>
...
<ul class="xiangqing_xinxi">
    ...
    <!--{if $xinxi['find']==2}-->    
      ...
      <a>自我简介：</a></br><span style="font-size:15px;">$xinxi['description']</span></br></br></br>
   <!--{/if}-->
   <!--{if $xinxi['find']==1}-->    
      <a>岗位职责：</a><span style="font-size:15px;">$xinxi['duty']</span></br></br>
      <a>任职要求：</a><span style="font-size:15px;">$xinxi['demand']</span></br></br>
      <a>职位描述：</a></br><span style="font-size:15px;">$xinxi['other_state']</span></br></br></br>
      <a>单位简介：</a></br><span style="font-size:15px;">$xinxi['description']</span></br></br></br>
   <!--{/if}-->
