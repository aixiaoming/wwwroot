...
<header id="header">
    ...
    <div>
        <a href="user_login.php" style="color:#ffffff;">登录</a>
    </div>
</header>
...
<div id="reg_container">
    ...
    <div class="form">
       ...
       <!--  <label>　验证码</label> -->
        <input type="text" name="captcha1" placeholder="请输入验证码" id="captcha">
        <img src="captcha.php" id="captcha_img" onclick="this.setAttribute('src','captcha.php')" title="点击刷新"/><br>
        <div style="margin-bottom: 40px;">
            <input type="checkbox" name="agreement1" style="width:12px;height:12px;margin:0px;margin-left:8%;">
    ...
    <div id="form" style="display:none;">
       ...
       <!--  <label>　　手机</label> -->
        ...
        <!-- <label>确认密码</label> -->
        <input name="password4" type="password"  placeholder="确认密码" class="sub"><br>
        <div style="margin-bottom: 40px;">
            <input type="checkbox" name="agreement2" style="width:12px;height:12px;margin:0px;margin-left:8%;">
