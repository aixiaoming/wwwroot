...
<div class="right_container">
	...
	<table>
		<tr>
			...
			<td><a href="/published_intern.php"  class="type">实习</a></td>
		</tr>
	</table>
    ...
    <!--{if $user['administrator']==1}-->
        ...
        <table>
        	<tr>
        		<td><a href="published_intern.php" class="type">管理员个人发布</a></td>
        		<td><a href="published_intern.php?type=admin">网站总发布</a></td>
        	</tr>
        </table>
        <!--{/if}-->
        <!--{if $type=="admin"}-->
        <table>
        	<tr>
        		<td><a href="published_intern.php">管理员个人发布</a></td>
        		<td><a href="published_intern.php?type=admin" class="type">网站总发布</a></td>
        	</tr>
        </table>
        <!--{/if}-->
        </div>
    ...
    <!--{loop $intern $key}-->
        <div class="first">
            ...
            <div class="third">
                ...
                <div id="title">
                <div class="title">
                <a href="show.php?list=$key['id']&clickid=11"><span>$key['title']</span></a><br>
                </div>
               ...
               <!--{eval $usercity=ruiqia_query_fetch("select * from area where id='".$city."'");}-->
                 <!--{if $usercity['name']==''}-->
               <span>全国</span><span>-实习-</span><span>$key['class']</span>
               <!--{/if}-->

               <!--{if $usercity['name']!=''}-->
               <span>$usercity['name']</span><span>-实习-</span><span>$key['class']</span>
               <!--{/if}-->
                </div>
                </div>
            </div>
            <div class="four">
                <form method="post" action="intern_edit.php?querytype=update">
                <input name="editid" type="hidden" value="$key['id']"/>
                <input type="submit" value="修改" />
                </form>
                <form method="post" action="intern_edit.php?querytype=delete">
                <input name="editid" type="hidden" value="$key['id']"/>
