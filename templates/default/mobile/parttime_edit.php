...
<form id="message" method="post" action="parttime_sql.php">
...
<!-- 个人兼职 -->
 <!--{if $user['type']=="1"}-->
  ...
  <br/><label for="wage"><a class="bitian">* </a>期望薪资</label>
...
<!--{if $user['type']=="2"}-->
  ...
  <br/><label for="wage"><a class="bitian">* </a>薪资待遇</label>
  <input type='text' name="wage" id="wage" value="$check['wage']"/>

  <br/><label for="label">职位标签</label>
  <div style="display:inline-block; padding:0; margin:0; overflow:hidden; height:auto !important; ">
  <input type="checkbox" class="checkbox" name="label1" value="日结" <!--{if $check['label1']!=""}--> checked="checked" <!--{/if}-->/><span>日结</span><br/>
  <input type="checkbox" class="checkbox" name="label2" value="月结"  <!--{if $check['label2']!=""}--> checked="checked" <!--{/if}-->/><span>月结</span><br/>
  <input type="checkbox" class="checkbox" name="label3" value="完工结"  <!--{if $check['label3']!=""}--> checked="checked" <!--{/if}-->/><span>完工结</span>
  </div>
  ...
  <br/><label for="lasttime">应聘截止日期</label>
  <input type='date' name="lasttime" id="lasttime" value="$check['lasttime']" placeholder=""/>
...
<!-- 上传图片插件结束 -->
  ...
  <br/><div style="width:90px;height:200px;float:left;padding-right:10px;"><label for="editor4" style="line-height:15px !important;">其它说明</label></div>
  ...
  <select name="fee" id="fee">
    <option <!--{if $check['fee']=='0'}-->checked="checked"<!--{/if}--> value="不限">不限</option> 
    <option <!--{if $check['fee']=='1'}-->checked="checked"<!--{/if}--> value="不限" value="不收费">不收费</option> 
    <option <!--{if $check['fee']=='2'}-->checked="checked"<!--{/if}--> value="不限" value="收费">收费</option> 
  </select>
...
<!-- 个人兼职 -->
 <!--{if $user['type']=="1"}-->
  <input name="class"  id="class" type="hidden" value="$classname">
...
<!--{if $user['type']=="2"}-->
  ...
  <br/><label for="label">职位标签</label>
  <div style="display:inline-block; padding:0; margin:0; overflow:hidden; height:auto !important; ">
  <input type="checkbox" class="checkbox" name="label1" value="日结" /><span>日结</span><br/>
  <input type="checkbox" class="checkbox" name="label2" value="月结" /><span>月结</span><br/>
  <input type="checkbox" class="checkbox" name="label3" value="完工结" /><span>完工结</span>
</div>
...
$('#submitbutton').click(function(){
  ...
  }else if($.trim($("#wage").val())==""){    inputcheck('#wage',"#wage",'薪资不能为空');
