...
<div class="right_container">
    ...
    <table>
        <tr>
            ...
            <!--{if $user['test']==1}-->
            <td><a href="/published_idea.php"  class="type">创意集市</a></td>
            <!--{/if}-->
        </tr>
    </table>
    ...
    <!--{if $user['administrator']==1}-->
        ...
        <table>
        	<tr>
        		<td><a href="/published_idea.php" class="type">管理员个人发布</a></td>
        		<td><a href="/published_idea.php?type=admin">网站总发布</a></td>
        	</tr>
        </table>
        <!--{/if}-->
        <!--{if $type=="admin"}-->
        <table>
        	<tr>
        		<td><a href="/published_idea.php">管理员个人发布</a></td>
        		<td><a href="/published_idea.php?type=admin" class="type">网站总发布</a></td>
        	</tr>
        </table>
        <!--{/if}-->
        </div>
    ...
    <div class="empty">您还没有在创意集市发布过信息哦</div>
           ...
           <!--  <div class="second">
            ...
            <div class="third">
               <div class="img">
                ...
                <div id="title">
                <div class="title">
                <a href="show.php?list=$key['id']&clickid=14"><span>$key['title']</span></a><br>
                </div>
               ...
               <!--{eval $usercity=ruiqia_query_fetch("select * from area where id='".$city."'");}-->
                <!--{if $usercity['name']==''}-->
               <span>全国</span><span>-创意集市</span>
               <!--{/if}-->

               <!--{if $usercity['name']!=''}-->
               <span>$usercity['name']</span><span>-创意集市</span>
               <!--{/if}-->
                </div>
                </div>
            </div>
            <div class="four">
                <form method="post" action="idea_edit.php?querytype=update">
                <input name="editid" type="hidden" value="$key['id']"/>
                <input type="submit" value="修改" />
                </form>
                <form method="post" action="idea_edit.php?querytype=delete">
                <input name="editid" type="hidden" value="$key['id']"/>
