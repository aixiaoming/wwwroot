...
<!--{template inkPhoto}-->
    ...
    <ul class="xiangqing_xinxi2">
      <li><a class="show_li1">店铺名称：</a><a class="show_li2">$xinxi['name']</a></li>
      <li><a class="show_li1">服务内容：</a><a class="show_li2">$xinxi['content']</a></li>
      <li><a class="show_li1">服务宗旨：</a><a class="show_li2">$xinxi['aim']</a></li>
      <li><a class="show_li1">营业地址：</a><a class="show_li2">$xinxi['yingye']</a></li>
