...
<div class="right_container">
    <span class="top_span">最近发布信息-招聘应聘</span>

    <!--{if $user['administrator']==1}-->
        <div class="guanli">
        <!--{if $type=="" or $type==null}-->
            <a href="published_recruit.php" class="type">管理员个人发布</a>
            <a href="published_recruit.php?type=admin">　　网站总发布</a>
        <!--{/if}-->
        <!--{if $type=="admin"}-->
            <a href="published_recruit.php">管理员个人发布</a>
            <a href="published_recruit.php?type=admin" class="type">　　网站总发布</a>
        <!--{/if}-->
        </div>
    <!--{/if}-->
    ...
    <!--{loop $recruit $key}-->
        <div class="first">
            ...
            <div class="third">
                ...
                <div id="title">
                <a href="show.php?list=$key['id']&clickid=12"><span class="title">$key['title']</span></a><br>
                </div>
                <div class="time">
