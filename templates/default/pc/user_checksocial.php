...
<div class="check_container">
    ...
    <!-- <div class="picture"> -->
        <div class="img1">
           <img src="/data/idcard/$user['id'].jpg?rand=<!--{eval echo mt_rand(1000,9999);}-->" onerror=this.src="/data/idcard/socialz.png" id="userlogoimg" onclick="document.getElementById('fileupload1').click()">
        </div>
        <div class="img2">
          <img src="/data/student/$user['id'].jpg?rand=<!--{eval echo mt_rand(1000,9999);}-->" onerror=this.src="/data/idcard/socialf.png" id="userlogoimg2" onclick="document.getElementById('fileupload2').click()">
        </div>
    <!--  </div> -->
    <div class="bar">
        <label>基本信息</label>
        ...
        $("#myupload2").ajaxSubmit({
            ...
            success: function(data) {
                ...
                if(data.type == 'warning')
                {
                    ...
                    $("#userlogoimg2").attr("src",'/data/idcard/socialf.png');
           ...
           complete: function() 
             ...
             success: function(msg)
             {
                ...
                if(msg.type == 'success')
                {
                   ...
                   ruiqia_location('/social.php',1500);
