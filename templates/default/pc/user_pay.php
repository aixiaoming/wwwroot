...
<div class="usercheckpay_container">
        ...
        <!--{if $user['administrator']==2}-->
          ...
          <li><a href="social.php">社会个人认证会员</a></li>
            ...
            <!--{if $user['type']==2}--> 
                 ...
                 <li style="border-left:3px solid #e96c1f;padding-left:47px;"><a href="user_checkrmb.php"><a href="user_pay.php">企业VIP会员</a></li>
                 <li><a href="list.php?class=169&mokuai=active&hit=1&clickid=7">会员专属活动</a></li>
                 <li><a href="news.php">我的消息</a></li>
                 <!--{/if}-->
                 <!--{if $user['test']==1 or $user['test']==2 or $user['test']==5 or $user['test']==6}-->
...
<div class="checkpay_container">
<span class="top_span">企业VIP会员</span>
   <div class="bar">
        <label>企业VIP会员简介</label>
    </div>
    <div class="textarea">$club['vip']</div>
    <!--{if $user['vip']==0}-->
        <div class="bar">
            <label>提交资料申请企业VIP会员</label>
        </div>
        ...
        <div class="img">
        <div class="textarea1"><label>营业执照</label></div>
            ...
            <div class="textarea1"><label>单位简介</label></div>
   ...
   <!--{if $user['vip']==1}-->
     ...
     <!--{if $user['test']==3}-->
     <div style="margin-left:100px;margin-top:30px;color:#ff0000;">您的申请正在审核中，请耐心等待。</div>
     <!--{/if}-->
     <!--{if $user['test']==4}-->
     <div style="margin-left:100px;margin-top:30px;color:#ff0000;">您的申请未通过审核，请<a href="user_check2.php"><button>再次申请</button></a>。</div>

     <!--{/if}-->
     <!--{if $user['test']==6}-->
     <div style="margin-left:100px;margin-top:30px;color:#ff0000;">您已经是企业VIP会员了。</div>
