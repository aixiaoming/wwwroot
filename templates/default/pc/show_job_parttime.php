    ...
    <ul class="xiangqing_xinxi3">
      ...
      <!-- 职位标签没写 -->
        <!--{/if}-->
          ...
          <!--{if $xinxi['find']==1}-->  
          <!-- 招兼职 -->
      <li><a class="show_li1">单位名称：</a><a class="show_li2">$xinxi['name']</a></li>
      ...
      <li><a class="show_li1">招聘人数：</a><a class="show_li2">$xinxi['people']</a></li>
      <li><a class="show_li1">薪资待遇：</a><a class="show_li2">$xinxi['wage']</a></li>
      <li><a class="show_li1">职位标签：<input type="checkbox" class="checkbox" disabled="true" name="label[]" value="日结" <!--{if $xinxi['label1']!=""}--> checked="checked" <!--{/if}-->/>日结
...
<div class="wupinxiangqing">
  ...
  <div class="wupinxiangqing_contain"> 
   ...
   <!--{if $xinxi['find']==2}-->    
        ...
        <a class="show_li3">工作经验：</a><a class="show_li2">$xinxi['experience']</a></br></br>
        <a class="show_li3">院校：</a><a class="show_li2">$xinxi['school']</a></br></br>
        <a class="show_li3">自我描述：</a><a class="show_li4">$xinxi['description']</a>
      <a class="show_li3">个人照片：</a></br>
   <!--{/if}-->
   <!--{if $xinxi['find']==1}-->    
        <a class="show_li3">工作地点：</a><a class="show_li2">$xinxi['address']</a></br></br>
        
        <a class="show_li3">岗位职责：</a><a class="show_li4">$xinxi['duty']</a>
        <a class="show_li3">任职要求：</a><a class="show_li4">$xinxi['demand']</a>
        <a class="show_li3">其他说明：</a><a class="show_li4">$xinxi['other_state']</a>
