...
<style type="text/css">
  textarea { border:#DADBDF solid 1px;};
</style>
</head>
<body>
...
<!--{if $user['type']=="2"}-->
  ...
  <label for="wage"><a>* </a>薪资待遇</label>
  <input type='text' name="wage" id="wage" value="$check['wage']"/>

  <br/><label for="label">职位标签</label>
  <input type="checkbox" class="checkbox" name="label1" value="日结" <!--{if $check['label1']!=""}--> checked="checked" <!--{/if}-->/>日结
  <input type="checkbox" class="checkbox" name="label2" value="月结"  <!--{if $check['label2']!=""}--> checked="checked" <!--{/if}-->/>月结
  <input type="checkbox" class="checkbox" name="label3" value="完工结"  <!--{if $check['label3']!=""}--> checked="checked" <!--{/if}-->/>完工结

  <br/><label for="people">招聘人数</label>
  <input type='number' name="people" id="people" value="$check['people']" placeholder=""/>

  <label for="education"><a>* </a>学历要求</label>
  <select name="education" id="education">
    <option value="$check['education']">$check['education']</option> 
    <option value="不限">不限</option> 
    <option value="大专">大专</option> 
  ...
  <label for="experience"><a>* </a>工作经验</label>
  <select name="experience" id="experience">
    <option value="$check['experience']">$check['experience']</option> 
    <option value="无">无</option> 
    <option value="1年">1年</option> 
...
<br/>
  ...
  <br/><label for="other_state" style="height:125px !important; width:125px !important; float:left;">其它说明</label>
...
<!--{if $user['type']=="2"}-->
  ...
  <br/><label for="label">职位标签</label>
  <input type="checkbox" class="checkbox" name="label1" value="日结" />日结
  <input type="checkbox" class="checkbox" name="label2" value="月结" />月结
  <input type="checkbox" class="checkbox" name="label3" value="完工结" />完工结
