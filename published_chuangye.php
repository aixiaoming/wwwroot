...
if ($type=="admin") {
	$goods = ruiqia_page("SELECT * from startup  ORDER BY time DESC",5,7,'page');
}
if ($type==''or $type==null) {
	$goods = ruiqia_page("SELECT * from startup WHERE userid='".$_SESSION['userid']."' ORDER BY time DESC",5,7,'page');
}
